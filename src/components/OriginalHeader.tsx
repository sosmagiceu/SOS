...
// English is the only language for now — flip this back on once translations ship.
  ...
  return <div className="site-topbar" id="siteTopbar" ref={headerRef}>
    <div className="inner">
      ...
      <div className="topbar-actions">
        {SHOW_LANGUAGE_SWITCHER && <div className="menu-wrap" onMouseEnter={() => setOpen('lang')} onMouseLeave={() => setOpen(null)}>
